...
export const SearchPanelMin = (props) => {
    const {city, country, guestCounter} = props.filters,
          {setVisibleGuestsSelector, setVisibleLocationSelector, showBigSearchPanel} = props;
    ...
    return (
        <div className="search-panel-min">
            <button onClick={(e) => {
                    ...
                    className="search-panel-min__place">{city || country ?  `${city}, ${country}` : 'Add location'}
            </button>
            <button onClick={(e) => {
                        showBigSearchPanel(e);
                    ...
                    className="search-panel-min__guest">{guestCounter <= 0 ? 'Add guests' : `${guestCounter} guests`}
            </button>
            <button onClick={(e) => {
                        showBigSearchPanel(e);
                        setVisibleLocationSelector(false);
                    ...
                    className="search-panel-min__search">
